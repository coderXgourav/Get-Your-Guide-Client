...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | Kyptronix LLP - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for Kyptronix LLP - React.js Tailwind CSS Admin Dashboard Template"
      />
