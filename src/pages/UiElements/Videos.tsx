...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Kyptronix LLP - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Kyptronix LLP - React.js Tailwind CSS Admin Dashboard Template"
      />
