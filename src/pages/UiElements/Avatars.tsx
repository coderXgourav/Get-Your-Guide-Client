...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Kyptronix LLP - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Kyptronix LLP - React.js Tailwind CSS Admin Dashboard Template"
      />
